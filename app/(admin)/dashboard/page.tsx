              ...
              <CardContent>
                <ul className="list-disc pl-5 space-y-2 text-sm text-muted-foreground">
                  <li>
                    ...
                    Receives a fixed <span className="font-bold">30%</span> of
                  ...
                  <li>
                    ...
                    The remaining <span className="font-bold">70%</span> is
                    pooled together.
                  </li>
                  <li>
                    <span className="font-medium text-foreground">
                  ...
                  <li>
                    Calculations are based on transactions from the 1st to the
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {formatNumber(overviewStats.grandTotal.items)}
                </div>
                <p className="text-xs text-muted-foreground">
                  Templates, Designs, Components
                </p>
              </CardContent>
            </Card>
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {formatNumber(overviewStats.grandTotal.views)}
                </div>
                <p className="text-xs text-muted-foreground">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {formatNumber(overviewStats.grandTotal.interactions)}
                </div>
                <p className="text-xs text-muted-foreground">
                  Downloads & Copies
                </p>
              ...
              <CardHeader>
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <CardDescription>
                      {formatNumber(overviewStats.templates.total)} items
                    </CardDescription>
                  </div>
                </div>
              </CardHeader>
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div className="flex flex-col">
                    ...
                    <span className="font-semibold">
                      {formatNumber(overviewStats.templates.totalViews)}
                    </span>
                  </div>
                  <div className="flex flex-col">
                    <span className="text-muted-foreground">Downloads</span>
                    <span className="font-semibold">
                      {formatNumber(overviewStats.templates.totalDownloads)}
                    </span>
                  </div>
                  <div className="flex flex-col">
                    <span className="text-muted-foreground">Free</span>
                    <span className="font-semibold text-green-600">
                      {formatNumber(overviewStats.templates.freeCount)}
                    </span>
                  </div>
                  <div className="flex flex-col">
                    <span className="text-muted-foreground">Pro</span>
                    <span className="font-semibold text-purple-600">
                      {formatNumber(overviewStats.templates.proCount)}
                    </span>
                  </div>
                </div>
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p
                          ...
                          title={overviewStats.templates.mostPopular.title}
                        >
                          {overviewStats.templates.mostPopular.title}
                        </p>
                        <p className="text-xs text-muted-foreground">
                          {formatNumber(
                            overviewStats.templates.mostPopular.count,
                          )}{' '}
                          downloads
                        </p>
                      </div>
              ...
              <CardHeader>
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <CardDescription>
                      {formatNumber(overviewStats.designs.total)} items
                    </CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="space-y-4 flex-1">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div className="flex flex-col">
                    <span className="text-muted-foreground">Views</span>
                    <span className="font-semibold">
                      {formatNumber(overviewStats.designs.totalViews)}
                    </span>
                  </div>
                  <div className="flex flex-col">
                    <span className="text-muted-foreground">Downloads</span>
                    <span className="font-semibold">
                      {formatNumber(overviewStats.designs.totalDownloads)}
                    </span>
                  </div>
                  <div className="flex flex-col">
                    <span className="text-muted-foreground">Free</span>
                    <span className="font-semibold text-green-600">
                      {formatNumber(overviewStats.designs.freeCount)}
                    </span>
                  </div>
                  <div className="flex flex-col">
                    <span className="text-muted-foreground">Pro</span>
                    <span className="font-semibold text-purple-600">
                      {formatNumber(overviewStats.designs.proCount)}
                    </span>
                  </div>
                </div>
                  ...
                  <div className="pt-4 border-t mt-auto">
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p
                          className="text-sm font-medium line-clamp-1"
                          title={overviewStats.designs.mostPopular.title}
                        >
                          {overviewStats.designs.mostPopular.title}
                        </p>
                        <p className="text-xs text-muted-foreground">
                          {formatNumber(
                            overviewStats.designs.mostPopular.count,
                          )}{' '}
                          downloads
                        </p>
                      </div>
              ...
              <CardHeader>
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <CardDescription>
                      {formatNumber(overviewStats.components.total)} items
                    </CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="space-y-4 flex-1">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div className="flex flex-col">
                    <span className="text-muted-foreground">Views</span>
                    <span className="font-semibold">
                      {formatNumber(overviewStats.components.totalViews)}
                    </span>
                  </div>
                  <div className="flex flex-col">
                    <span className="text-muted-foreground">Copies</span>
                    <span className="font-semibold">
                      {formatNumber(overviewStats.components.totalDownloads)}
                    </span>
                  </div>
                  <div className="flex flex-col">
                    <span className="text-muted-foreground">Free</span>
                    <span className="font-semibold text-green-600">
                      {formatNumber(overviewStats.components.freeCount)}
                    </span>
                  </div>
                  <div className="flex flex-col">
                    <span className="text-muted-foreground">Pro</span>
                    <span className="font-semibold text-purple-600">
                      {formatNumber(overviewStats.components.proCount)}
                    </span>
                  </div>
                </div>
                  ...
                  <div className="pt-4 border-t mt-auto">
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p
                          className="text-sm font-medium line-clamp-1"
                          title={overviewStats.components.mostPopular.title}
                        >
                          {overviewStats.components.mostPopular.title}
                        </p>
                        <p className="text-xs text-muted-foreground">
                          {formatNumber(
                            overviewStats.components.mostPopular.count,
                          )}{' '}
                          copies
                        </p>
                      </div>
