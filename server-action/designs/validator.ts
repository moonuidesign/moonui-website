...
export const ContentDesignSchema = z
  .object({
    ...
    imagesUrl: z.array(z.string()).optional(), // Array of strings (URLs/Keys)
    newImages: z.array(z.instanceof(File)).optional(),
    sourceFile: z
      .union([
        z.instanceof(File),
        z.string().min(1, 'File sumber wajib diisi'), // Allow URL/Key string
      ])
