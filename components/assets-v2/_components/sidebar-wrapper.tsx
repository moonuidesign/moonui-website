...
export default function SidebarWrapper() {
  const { tool, contentType, setCategory, toggleSubCategory } = useFilter();
  ...
  return (
    <SidebarFilter
      gradientCategories={
        categories.gradientCategories[tool] || categories.gradientCategories.all || []
      }
      componentCategories={
        categories.componentCategories[tool] || categories.componentCategories.all || []
      }
      templateCategories={
        categories.templateCategories[tool] || categories.templateCategories.all || []
      }
