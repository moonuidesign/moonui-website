...
import { Edit, Eye, Copy, Trash, MoreHorizontal, ExternalLink } from 'lucide-react';
import Link from 'next/link';
import Image from 'next/image';
import { DashboardPagination } from '@/components/dashboard/dashboard-pagination';
import { toast } from 'react-toastify';
import { deleteContentComponent } from '@/server-action/components/deleteComponent';
  ...
  const handleDelete = (id: string) => {
    if (confirm('Are you sure you want to delete this component? This action cannot be undone.')) {
      startTransition(async () => {
        const res = await deleteContentComponent(id);
        if (res.error) {
                    ...
                    <TableCell className="text-right">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          <Link href={`/components/${item.id}`} target="_blank">
                            <DropdownMenuItem>
