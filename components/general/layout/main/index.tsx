...
export default function MainLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      ...
      >
        <div className="relative z-[1000] h-fit w-full md:z-[1040] md:p-2">
        ...
        <div className="relative z-[1000] -mt-[168px] h-fit overflow-hidden rounded-t-[39px] bg-[#E7E7E7] pt-24 md:-mt-[20px] md:overflow-visible md:rounded-none md:bg-none md:pt-0">
