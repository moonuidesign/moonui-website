...
export default function RootLayout({
  ...
  return (
    <div className="min-h-screen overflow-hidden md:max-h-[900px] lg:max-h-[800px]  h-screen bg-zinc-950">
      <motion.div
        animate={
          isFilterOpen
        ...
        className={`min-h-screen h-full w-full bg-[#E7E7E7] origin-top ${
      ...
      >
        ...
        <div className="rounded-t-2xl md:rounded-0 md:m-0  -mt-[150px] h-full w-full">
