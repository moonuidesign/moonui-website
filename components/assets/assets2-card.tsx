...
export const Assets2Card: React.FC<Assets2CardProps> = ({
    ...
    return (
        ...
        >
            {/* Image Container */}
            <div
                className={`self-stretch relative bg-white rounded-2xl shadow-card-sm border border-white overflow-hidden group transition-all duration-300 ${contentType === 'templates' ? 'aspect-[360/480]' : 'aspect-[360/260]' // Gunakan aspect ratio hanya jika bukan templates
                    }`}
            >
                {imageUrl ? (
                    <Image
