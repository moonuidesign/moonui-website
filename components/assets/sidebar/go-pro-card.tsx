...
export const GoProCard = () => {
  return (
    <div className="flex w-full flex-col items-center justify-center gap-3 overflow-hidden rounded-[20px] border border-gray-200 bg-zinc-900 px-3 pt-6 pb-3 shadow-sm md:h-[33%] lg:h-[40%]">
      <Image
