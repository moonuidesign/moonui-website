...
export const ResourceCard2: React.FC<ResourceCardProps> = ({
  id,
  title,
  imageUrl,
  tier,
  ...
  return (
    ...
    >
      {/* Image Container */}
      <div
        className={`self-stretch relative bg-white rounded-2xl shadow-card-sm border border-white overflow-hidden group transition-all duration-300 ${contentType === 'templates' ? 'h-[420px]' : 'aspect-[360/260]' // Gunakan aspect ratio hanya jika bukan templates
          }`}
      >
        {imageUrl ? (
          <Image
            ...
            className={`object-cover rounded-lg ${contentType === 'templates' ? 'object-top' : 'object-center'
              }`}
